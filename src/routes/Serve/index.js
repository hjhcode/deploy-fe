    ...
    const columns = [{
      ...
      render: (id, record) => (
        <span>
          ...
          <a onClick={() => this.buildProject(id)}>部署</a>
          <Divider type="vertical" />
          <Popconfirm
            placement="left"
          ...
          <div>
            <Row>
              ...
              <Col xs={24} sm={24} md={12} lg={16} xl={16} style={{ textAlign: 'right' }}>
                <Button type="primary" style={{marginRight: 20}} onClick={this.addProject}>新增服务</Button>
                <Search
                  placeholder="输入服务名进行搜索"
                  style={{ width: 200 }}
